...
export const KNOWN_ODDS = {
  ...
  // ── Sweet 16 Thursday ── (DraftKings)
  "Purdue|Texas": { spread: -7.5, homeML: -360, awayML: 285, home: "Purdue" },
  "Iowa|Nebraska": { spread: -1.5, homeML: -130, awayML: 110, home: "Nebraska" },
  "Arizona|Arkansas": { spread: -7.5, homeML: -375, awayML: 295, home: "Arizona" },
  "Houston|Illinois": { spread: -2.5, homeML: -145, awayML: 122, home: "Houston" },
  // ── Sweet 16 Friday ── (add as lines are published)
};
...
export const KNOWN_RESULTS = {
  East: {
    0: { 0:1, 1:9, 2:5, 3:4, 4:6, 5:3, 6:7, 7:2 },
    1: { 0:1, 1:5, 2:3, 3:2 },
  },
  South: {
    0: { 0:1, 1:9, 2:5, 3:4, 4:11, 5:3, 6:10, 7:2 },
    1: { 0:9, 1:4, 2:3, 3:2 },
    2: { 0:9, 1:3 },  // S16: Iowa over Nebraska, Illinois over Houston
  },
  West: {
    0: { 0:1, 1:9, 2:12, 3:4, 4:11, 5:3, 6:7, 7:2 },
    1: { 0:1, 1:4, 2:11, 3:2 },
    2: { 0:1, 1:2 },  // S16: Arizona over Arkansas, Purdue over Texas
  },
  Midwest: {
    0: { 0:1, 1:9, 2:5, 3:4, 4:6, 5:3, 6:7, 7:2 },
    1: { 0:1, 1:4, 2:6, 3:2 },
