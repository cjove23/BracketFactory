    ...
    const games = events.map(event => {
      ...
      return {
        ...
        odds: (() => {
          const o = comp.odds?.[0];
          if (!o) return null;
          // ESPN NCAAMB: moneyline lives at o.moneyline.home.close.odds (string like "-142")
          ...
          // Spread values from pointSpread object
          const homeSpread = ps?.home?.close?.line ?? null;
          const awaySpread = ps?.away?.close?.line ?? null;
