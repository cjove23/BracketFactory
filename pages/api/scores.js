    ...
    const games = events.map(event => {
      ...
      return {
        ...
        odds: (() => {
          const o = comp.odds?.[0];
          if (!o) return null;
          // ESPN uses different field names across sports — try all known paths
          const homeOdds = o.homeTeamOdds || {};
          const awayOdds = o.awayTeamOdds || {};
          return {
            spread: o.spread ?? o.details ?? null,
            overUnder: o.overUnder ?? null,
            homeSpread: homeOdds.spreadOdds ?? homeOdds.spread ?? null,
            awaySpread: awayOdds.spreadOdds ?? awayOdds.spread ?? null,
            homeML: homeOdds.moneyLine ?? homeOdds.odds ?? null,
            awayML: awayOdds.moneyLine ?? awayOdds.odds ?? null,
            provider: o.provider?.name ?? null,
            // Pass raw for debugging — remove later
            _raw: { keys: Object.keys(o), homeKeys: Object.keys(homeOdds), awayKeys: Object.keys(awayOdds) },
          };
        })(),
